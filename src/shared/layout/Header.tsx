...
const titles: Record<string, string> = {
  ...
  '/admin/orders': 'Заказы платформы',
  '/admin/orders/new': 'Создание заказа',
  '/admin/drivers': 'Водители платформы',
  '/admin/cars': 'Автомобили',
  '/admin/passengers': 'Пассажиры',
  '/admin/taxi-parks': 'Таксопарки',
  '/admin/tariffs': 'Тарифы платформы',
  '/admin/commissions': 'Комиссии платформы',
  '/admin/payouts': 'Выплаты',
  '/admin/zones': 'Зоны обслуживания',
  '/admin/support': 'Поддержка',
  '/admin/analytics': 'Аналитика',
  '/admin/map': 'Операционная карта',
  '/admin/geocoder': 'Доверенные геоточки',
  '/admin/promocodes': 'Промокоды',
  '/admin/users': 'Администраторы',
  '/admin/roles': 'Роли и права',
  '/admin/audit-logs': 'Аудит действий',
